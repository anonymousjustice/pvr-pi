...
struct PageDesc
{
	...
	bool				bHasElements;		// Specifies whether the page has elements
};
...
{
	// Container			Clip Shape			Has elements
	{ eGROUP_CONTAINER,		eCLIPSHAPE_NONE,	true },		// eDISPPAGE_CLOCKS
	{ eGROUP_CONTAINER,		eCLIPSHAPE_NONE,	true },		// eDISPPAGE_WEATHER
	{ eGROUP_WINDOW,		eCLIPSHAPE_WINDOW,	false },	// eDISPPAGE_WINDOW
};
...
OGLES2ExampleUI::OGLES2ExampleUI() : m_uiTextureAtlas(0), m_uiTextureBase(0), m_uiBaseW(0), m_uiBaseH(0), m_uiAtlasW(0), m_uiAtlasH(0), m_uiFBOAtlas(0), m_uiFBOBase(0), m_bAtlasGenerated(false),
									 ...
									 m_CurrentPage(eDISPPAGE_DEFAULT), m_i32CycleDirection(1), m_iDrawCallsPerFrame(0), m_fWinRotPerc(0.0f), m_ulPreviousTransTime(0)
{
	// Calculate some offsets
	PVRTVertex dummy;
	m_i32VOffset		= (char*)(&dummy.vPos)        - (char*)(&dummy.vPos);
	m_i32UVOffset		= (char*)(&dummy.vUV)         - (char*)(&dummy.vPos);
	m_i32RGBAOffset		= (char*)(&dummy.u8RGBA)      - (char*)(&dummy.vPos);
	m_i32TransIdxOffset = (char*)(&dummy.fTransIndex) - (char*)(&dummy.vPos);
...
bool OGLES2ExampleUI::RenderScene()
{
    ...
    m_Print3D.DisplayDefaultTitle("Example UI", c_apszDisplayOpts[m_uiDisplayOpt], ePVRTPrint3DLogoIMG);
	m_Print3D.Flush();
