...
NewNormalMap.pvr: $(MEDIAPATH)/NewNormalMap.png
	$(PVRTEXTOOL) -b1.0 -m -fOGLPVRTC4 -i$(MEDIAPATH)/NewNormalMap.png -o$@
...
wood.pvr: $(MEDIAPATH)/wood.png
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/wood.png -o$@

sail.pvr: $(MEDIAPATH)/sail.png
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/sail.png -o$@

MountainFloor.pvr: $(MEDIAPATH)/mountain6.png
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/mountain6.png -o$@
