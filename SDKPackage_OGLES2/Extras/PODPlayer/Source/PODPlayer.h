...
protected:
	...
	// Camera
	pvrengine::SimpleCamera	*m_pCamera;
	...
	pvrengine::TimeController		m_sTimeController;
	pvrengine::UniformHandler		m_UniformHandler;
	pvrengine::ContextManager		m_sContextManager;
	...
	CPVRTString		m_strDemoTitle, m_strDemoSubTitle;
	...
	// does multi-stage initialising providing feedback to the user
	bool Init();
