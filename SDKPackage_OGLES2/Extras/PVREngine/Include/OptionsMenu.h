...
namespace pvrengine
{
	...
	*****************************************************************************/
	...
	@Input				pTimeController	- gives time valus for menu animation
	@Description		basic constructor taking print3d (required for menu).
	*****************************************************************************/
		OptionsMenu(CPVRTPrint3D* pPrint3D, TimeController *pTimeController);
	...
	*****************************************************************************/
	...
	private:
		...
		TimeController		*m_pTimeController;	/*! for animation */
