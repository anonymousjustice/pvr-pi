...
namespace pvrengine
{
	...
	enum EGeometryPrimitiveType /*! note this is no longer anything to do with EPODPrimitiveType */
	{
		eTriangles=0,
		eLines,	/*!< Lines for Wireframe mode */
		eGeometryPrimitiveType
	};
	...
	*****************************************************************************/
	...
	public:
		...
		*****************************************************************************/
		...
		/*!***************************************************************************
		@Function			Mesh
		@Input				psScene - POD scene where this mesh came from
		@Input				iIndex - index into mesh list in the POD scene
	...
	private:
		...
		EGeometryPrimitiveType	m_eGeometryPrimitiveType;		/*! lines, triangles etc. */
