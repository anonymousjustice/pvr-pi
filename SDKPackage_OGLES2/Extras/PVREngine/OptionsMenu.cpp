...
namespace pvrengine
{
	...
	OptionsMenu::OptionsMenu(CPVRTPrint3D *pPrint3D, TimeController *pTimeController)
	{
		m_pPrint3D = pPrint3D;
	...
	void OptionsMenu::render()
	{
		...
		// do pulse
		m_f32BrightnessMod+=VERTTYPEMUL(m_f32BrightnessModDirection,m_pTimeController->getDeltaTime());
